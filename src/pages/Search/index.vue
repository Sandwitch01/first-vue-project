  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @tapTrade="tapTrade" @tapAttr="tapAttr"/>
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:searchParams.order.indexOf('1') > -1}" @click="changeOrder('1')">
                  <a>综合 <span v-show="searchParams.order.indexOf('1') > -1" class="iconfont"
                              :class="{'icon-down':isDesc,'icon-up':isAsc}"></span>
                  </a>
                </li>
                <li :class="{active:searchParams.order.indexOf('2') > -1}" @click="changeOrder('2')">
                  <a>价格 <span v-show="searchParams.order.indexOf('2') > -1" class="iconfont"
                              :class="{'icon-down':isDesc,'icon-up':isAsc}"></span>
                  </a>
                </li>
              </ul>
  ...
  export default {
    ...
    methods:{
      ...
      changeOrder(flag){
        ...
        let newOrder = ""
        if (oldFlag === flag) {
          newOrder = this.searchParams.order.includes('desc') ? 'asc' : 'desc'
        } else {
          newOrder = 'desc'
        }
